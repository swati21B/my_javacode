...
public class Amazon_Cart_IncreaseQuant_4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		search.sendKeys("brush"+Keys.ENTER);
		WebElement FirstBrush = driver.findElement(By.xpath("(//a[@class='a-link-normal s-no-outline'])[1]"));
		FirstBrush.click();
