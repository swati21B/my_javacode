...
public class ListnerClass implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		File destination= new File("C:\\Users\\SwatiBodhale\\eclipse-workspace\\ProjectSelenium_M\\src\\Screenshots\\Passed TC\\TestCasePassed"+Time+".png");
		try {
	...
	public void onTestFailure(ITestResult result) {
		...
		File destination2= new File("C:\\Users\\SwatiBodhale\\eclipse-workspace\\ProjectSelenium_M\\src\\Screenshots\\Failed TC\\TestCaseFailed"+Time+".png");
	try {
